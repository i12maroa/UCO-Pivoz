...
def validate_keyword(keyword):
    ...
    reserved_keys = ['pivoz', 'todos', 'todas', 'mostrar', 'muestra', 'ver', 'enseña', 'abre', 'siguiente', 'anterior', 'adelante', 'atras', 'subirvolumen', 'bajarvolumen', 'videos', 'fotos', 'imagenes', 'fotografias', 'play', 'pause', 'continuar', 'en']
