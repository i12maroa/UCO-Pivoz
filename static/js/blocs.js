...
function lightBox(target, e) // Create Lightbox Modal
	{
		//e.preventDefault();
		targetLightbox = $(target);
		console.log(targetLightbox.attr('data-lightbox'));
		...
		var customModal = $('' +
			'<div id="lightbox-modal" class="modal fade">' +
				'<div class="modal-dialog">' +
					'<div class="modal-content '+lightBoxFrame+' blocs-lb-container">' +
						'<button id="blocs-lightbox-close-btn" type="button" class="close-lightbox" data-dismiss="modal" aria-label="Close">' +
							'<span aria-hidden="true">&times;</span>' +
						'</button>' +
						'<div class="modal-body">' +
							'<a href="#" class="prev-lightbox" aria-label="prev">' +
								'<span class="fa fa-chevron-left"></span>' +
							'</a>' +
							'<a href="#" class="next-lightbox" aria-label="next">' +
								'<span class="fa fa-chevron-right"></span>' +
							'</a>' +
							'<img id="lightbox-image" class="img-responsive" src="'+lightBoxPath+'">' +
							'<div id="lightbox-video-container" class="embed-responsive embed-responsive-16by9">' +
								'<video onloadstart="this.volume=0.5" controls autoplay class="embed-responsive-item">' +
									'<source id="lightbox-video" src="'+lightBoxPath+'" type="video/mp4">' +
								'</video>' +
							'</div>' +
							''+captionData+'' +
						'</div>' +
